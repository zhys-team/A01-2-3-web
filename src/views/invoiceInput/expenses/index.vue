...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tableSetting: {
          // url: 'https://xcx.ft-link.cn/cj/activity-api/page', // 请求路径已经确定
          isSearch: {
          ...
          tableData: [],
          httpData: { specialType: 'dl_zzsfp' }, // 请求初始参数
        },
        seniorSearchSet: {
          // 高级筛选内容设置
          fplx: [
            { lable: '普通发票', val: '10101' },
            { lable: '电子普票', val: '10102' },
            { lable: '普票卷票', val: '10103' },
            { lable: '过路过桥费', val: '10507' },
            { lable: '通行费电子发票', val: '10107' },
            { lable: '定额发票', val: '10200' },
            { lable: '商业小票', val: '20100' },
          ],
